...
export const CRAFTING_RECIPE_METADATA_OVERRIDES: ReadonlyArray<{
  ...
  },
  {
    ...
    sourceHint: 'Креслення приходить із першого квесту коваля, а матеріали збираються між Околицями Розбитої дороги та Лісом Чорного Ікла.',
  },
  {
    ...
    sourceHint: 'Нагорода за перехід у Ліс Чорного Ікла. Шукайте вовчі ікла саме в цій локації.',
  },
  {
